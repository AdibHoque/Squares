...
module.exports.run = (client,interaction,options) => {
    ...
    if(cmd) {
        ...
        try {
            ...
            return interaction.editReply({embeds:[errorEmbed("Please provide a valid command name.")]});
          }
