...
module.exports.data = new SlashCommandBuilder()
  ...
  .addUserOption((option) =>
    option
      .setName("user")
      .setDescription("The users info you want.")
      .setRequired(true)
  );
...
module.exports.run = async (client, interaction, options) => {
  ...
  const embed = new EmbedBuilder()
    .setAuthor({
      ...
      iconURL: person.avatarURL({ format: "png", dynamic: true, size: 256 }),
    })
    .setThumbnail(person.c)
    .addFields([
      {
        name: "Registered",
        value: person.createdAt.toLocaleString(),
        inline: true,
      },
      {
        name: "Joined At",
      ...
      { name: "User ID", value: person.id, inline: true },
      { name: "Badges", value: badges, inline: true },
      {
        name: "Avatar",
        value: `[128px](${person.avatarURL({
          format: "png",
          dynamic: true,
          size: 128,
        })}) [256px](${person.avatarURL({
          format: "png",
          dynamic: true,
          size: 256,
        })}) [512px](${person.avatarURL({
          format: "png",
          dynamic: true,
          size: 512,
        })})`,
