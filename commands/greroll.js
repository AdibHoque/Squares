...
module.exports.data = new SlashCommandBuilder()
  ...
  .addStringOption((option) =>
    option
      ...
      .setDescription("Message ID of the giveaway you wanna reroll.")
      .setRequired(true)
  );
...
module.exports.run = (client, interaction, options) => {
  ...
  if (!giveaway)
    return interaction.editReply({
      embeds: [errorEmbed(`Unable to find a giveaway for \`${query}\`.`)],
    });
  ...
  client.giveawaysManager
    ...
    .then(() => {
      interaction.editReply({
        embeds: [successEmbed("Giveaway has been rerolled!")],
      });
    })
    .catch((err) => {
