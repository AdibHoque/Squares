...
module.exports.run = async(client,interaction,options) => {
    if(!interaction.user.id === "496978159724396545") return interaction.editReply({embeds: [errorEmbed("**You do not have permisssion to use this command.**")], ephemeral: true});
    ...
    try {
        ...
        interaction.editReply({content: `**Input**\`\`\`js\n${code}\n\`\`\`\n**Output**\`\`\`${clean(evaled)}\`\`\``});
      } catch (err) {
