...
module.exports.data = new SlashCommandBuilder()
  ...
  .addStringOption((option) =>
    option.setName("author").setDescription("Set Author of the Embed.")
  )
  .addStringOption((option) =>
    option
      .setName("description")
      .setDescription("Set description of the Embed.")
  )
  .addStringOption((option) =>
    option.setName("thumbnail").setDescription("Thumbnail URL of the embed.")
  )
  .addStringOption((option) =>
    option.setName("image").setDescription("Image URL of the Embed.")
  );
...
module.exports.run = (client, interaction, options) => {
  ...
  const embed = new EmbedBuilder()
    .setTitle(title)
    .setColor("#F3BA2F")
    .setFooter({ text: `Embed created by ${interaction.user.username}` });
